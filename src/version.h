...
#define COMPASS_BUGFIX_LEVEL             0  /**< Bugfix level number */
#define COMPASS_BUGFIX_LEVEL_STRING     "0" /**< Bugfix level number string */
...
#define COMPASS_COPYRIGHT_YEAR_STRING   "2016" /**< Year of build */
